    ...
    <div class="fo-sb">
        ...
        <div class="fo-sb-content-container">
            ...
            <div class="fo-sb-content-body">
                <span class="fo-store-details">Listed above you'll find some of the best free shipping coupons, discounts and promotion codes as ranked by the users of RetailMeNot.com. To use a coupon simply click the coupon code then enter the code during the store's checkout process.</span>
            </div>
        </div>
    </div>
    <div class="fo-db">
        <div class="fo-db-heading">Free Shipping Coupons</div>
        @if(count($offers) > 0)
        <section id="filtered-offers">
            @include('partialviews.offers')
        </section>
        @else
        <div class="no-coupons-alert">No Free Shipping Coupons Available</div>
        @endif
    </div>
</div>
@endsection
