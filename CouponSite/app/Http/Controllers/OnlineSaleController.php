...
{
    public function getAllOnlineSaleOffers(Request $request){
        ...
        if($request->ajax()){
            ...
            ->get();
            return view('pages.onlinesale.allonlinesales',$data);
        }
    }
    public function getFilteredOnlineSaleOffers(Request $request){
