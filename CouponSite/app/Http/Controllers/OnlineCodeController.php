...
{
    public function getAllOnlineCodeOffers(Request $request){
        ...
        if($request->ajax()){
            ...
            ->get();
            return view('pages.onlinecode.allonlinecodes',$data);
        }
    }
    public function getFilteredOnlineCodeOffers(Request $request){
